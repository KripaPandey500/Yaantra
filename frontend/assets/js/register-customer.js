/* ============================================================
   register-customer.js — Yaantra Customer Registration
   ============================================================ */
'use strict';
...
function validateForm() {
    ...
    if (!firstName || !lastName || !emailOk || !phoneOk ||
        password.length < 8 || !confirm || !dob || !gender || !address) {
...
async function registerCustomer(event) {
    ...
    try {
        const response = await fetch(
            'http://localhost:5033/api/auth/register-customer',
            {
                method: 'POST',
        ...
        if (response.ok) {
            const successMsg = result.message || 'Customer registered successfully!';
